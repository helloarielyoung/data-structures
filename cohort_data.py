...
def unique_houses(filename):
    ...
    # #iterate through the file and grab the house name (index 2)
    # for line in data:
    #     person = line.split("|")
    #     house_name = person[2]
    # #add the house into the house set
    #     if house_name != '':
    #         houses.add(house_name)

    #another way - set comprehension
    #seems bad because we don't know what these things are!
    houses = {line.split("|")[2] for line in data if line.split("|")[2] != ''}
